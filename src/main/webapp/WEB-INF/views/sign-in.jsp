<%-- 
    Document   : sign-in
    Created on : Dec 15, 2018, 3:35:28 AM
    Author     : Phich.bur
--%>
...
<body class="login-page">
            ...
            <div class="body">
                <form id="sign_in" method="POST">
                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-4">
                            <a class="btn btn-block bg-pink waves-effect" href="home.jsp">SIGN IN</a>
                        </div>
                    </div>
    ...
    <script src="web_component/plugins/jquery-validation/jquery.validate.js"></script>

    <!-- Custom Js -->
    <script src="web_component/js/admin.js"></script>
    <script src="web_component/js/pages/examples/sign-in.js"></script>
</body>
